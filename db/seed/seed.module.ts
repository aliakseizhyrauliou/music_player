...
export class SeedModule {
  ...
  public async SeedArtist(): Promise<any> {
    ...
    SgtPeppersLonelyHeartsClubBand.name =
    ...
    SgtPeppersLonelyHeartsClubBandReprise.name =
    ...
    if ((await this.artistRepository.count()) == 0) {
      ...
      await this.albumEntity.insert([
        ...
        SystemOfADown,
        SgtPeppers,
        allThingsMustPassAlbum,
      ]);

      await this.trackEntity.insert([
        FifteenStep,
        AllINeed,
        Bodysnatchers,
        FaustArp,
      ...
      await this.trackEntity.insert([
        ...
        FixingAHole,
        SheLeavingHome,
        BeingForTheBenefitOfMrKite,
        WithinYouWithoutYou,
        WhenImSixtyFour,
        LovelyRita,
        GoodMorningGoodMorning,
        SgtPeppersLonelyHeartsClubBandReprise,
        ADayInTheLife,
      ]);
      await this.trackEntity.insert([
        idHaveYouAnytime,
